...
const STEPS = [
  ...
  },
  {
    n: 2,
    icon: '⚙️',
    title: 'Add or update in Vercel',
    body: 'Go to Project → Settings → Environment Variables. If ANTHROPIC_API_KEY already exists, click it to edit. Otherwise click "Add New":',
  ...
  },
  {
    ...
    icon: '🚀',
    title: 'Redeploy',
    body: 'After saving, go to Deployments → click the three-dot menu on the latest deploy → Redeploy. Changes take effect immediately.',
    action: null,
    code: null,
  },
];
